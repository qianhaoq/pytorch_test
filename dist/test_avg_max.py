...
from resnet import resnet18, resnet34, resnet50, resnet101, resnet152, avgnet18, maxnet18
# vgg out of memory
...
optimizers = [opt_resnet18, opt_avgnet18, opt_maxnet18]


# opt_name = ['SGD', 'Momentum', 'RMSprop', 'Adam', 'Adamax']
opt_name = ['resnet18', 'avgnet18', 'maxnet18']

# models_name = [model_SGD, model_Momentum, model_RMSprop, model_Adam, model_Adamax]
models_name = [model_resnet18, model_avgnet18, model_maxnet18]
line_name =  ['-', ':', '-.']
